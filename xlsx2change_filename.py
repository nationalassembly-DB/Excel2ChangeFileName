...
#! 동일 파일명 handling 필요. 엑셀 L열에 파일명 대신 폴더 경로를 사용하는 방법


def change_filename(excel_file_path, folder_path):
    ...
    for old_name, new_name in zip(old_names, new_names):
        for ext in extensions:
            old_file = os.path.join(folder_path, f"{old_name}.{ext}")
...
if __name__ == "__main__":
    ...
    change_filename(excel_file_path, folder_path)
    print("작업이 완료되었습니다.")
